...
export default function EducationDetails() {
  // @ts-ignore
  const { currentStep, boardList, collageList, courseList,universityList,completeProfile } = useSelector(
  ...
  const handleSubmit = (handleNextStep) => {
    ...
    const requestBody = {
      data: educationEntries.map(entry => {
        const baseEntry = {
          education_type: entry.type === "Graduate" ? 2 :1,
...
dispatch(submitEducationData(requestBody,handleNextStep))
